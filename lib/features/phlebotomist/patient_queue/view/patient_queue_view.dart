  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: 'Patient Queue',
        enableSearch: true,
        searchHint: 'Search by name, locality',
    ...
    return RefreshIndicator(
      ...
      child: Column(
        children: [
          ...
          // Visit-type context switch (Clinic / Home) + forward-looking
          // date horizon, in one compact 40px row so it doesn't compete
          // with the patient list for space.
          Padding(
