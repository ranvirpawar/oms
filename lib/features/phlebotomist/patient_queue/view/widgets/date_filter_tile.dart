...
/// and opens a small anchored popover on tap: Today / This week / Upcoming
/// / Past orders, plus a "Pick a date" row that opens a full calendar.
/// The calendar no longer gates on which days have orders — that data
/// isn't available client-side any more now that each filter fetches its
/// own date window from the API.
