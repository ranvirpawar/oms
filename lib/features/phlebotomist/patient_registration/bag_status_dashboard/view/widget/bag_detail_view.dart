...
class _PatientCard extends StatelessWidget {
  final PatientRegistrationRecord patient;
  final int index;
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _DetailRow(
                          svgPath: AppAssets.fileNoteIcon,
                          text: patient.sampleType,
                      ...
                      Expanded(
                        child: _DetailRow(
                          svgPath: AppAssets.calendarIcon,
                          text: formattedDate,
                  ...
                  if (hasFacility) ...[
                    const SizedBox(height: 6),
                    _DetailRow(
                      svgPath: AppAssets.facility,
                      text: patient.facilityName!,
