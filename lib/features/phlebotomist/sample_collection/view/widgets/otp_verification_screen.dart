...
import '../sample_collection_screen.dart';
 ...
 // 1. GetView<SampleCollectionController> -> GetView<OrderConfirmationController>.
 // 2. The `ever<SampleCollectionStep>` listener that lived in build() is
 //    gone. Registering a listener inside build() re-subscribes on every
 //    rebuild of this widget, which risked stacking up duplicate listeners
 //    (and duplicate navigation) if this screen ever rebuilt more than once
 //    while mounted. Navigation is now driven from
 //    OrderConfirmationController.verifyOtp(), which pops this screen
 //    directly on success — see that controller for the full flow.
 ...
 class OtpVerificationScreen extends GetView<OrderConfirmationController> {
